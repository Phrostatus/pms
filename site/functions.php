	...
	function dadosPessoais($pagina_inicial, $result)
	{
		if($pagina_inicial == 1)
		{
			...
			echo	"<form name=\"login\" id=\"login\" method=\"post\" action=\"submit_login.php\">
					<p> <input type=\"text\" name=\"mail\"	   id=\"mail\" 	 value=\"mail@host.com\" onClick=\"clear_mail(this)\" onBlur=\"restore_mail(this)\" autofocus=true/> </p>
					<p> <input type=\"text\" name=\"password\" id=\"password\" value=\"password\" 	   onClick=\"clear_password(this)\" onBlur=\"restore_password(this)\" onFocus=\"clear_password(this)\" /> </p>
		...
		else if($pagina_inicial == 2) //registo	
		{
			...
			echo	"<form name=\"login\" id=\"login\" method=\"post\" action=\"submit_login.php\">
					<p> <input type=\"text\" name=\"mail\"	   id=\"mail\" 	 value=\"mail@host.com\" onClick=\"clear_mail(this)\" onBlur=\"restore_mail(this)\"/> </p>
					<p> <input type=\"text\" name=\"password\" id=\"password\" value=\"password\" 	   onClick=\"clear_password(this)\" onBlur=\"restore_password(this)\" onFocus=\"clear_password(this)\" /> </p>
